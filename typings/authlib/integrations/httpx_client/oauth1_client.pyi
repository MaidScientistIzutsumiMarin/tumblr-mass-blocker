...
class AsyncOAuth1Client(OAuth1Client, AsyncClient):  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    async def fetch_request_token(self, url: str, **kwargs: object) -> dict[str, str]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    def create_authorization_url(self, url: str, request_token: str | None = None, **kwargs: object) -> str: ...
    def parse_authorization_response(self, url: str) -> dict[str, str]: ...
    async def fetch_access_token(self, url: str, verifier: str | None = None, **kwargs: object) -> dict[str, str]: ...
